	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 mx-auto text-center">
				<h2 class="section-heading">MOVIE LIST</h2>
				<hr class="my-4">
				<br>
				...
				<form action="${pageContext.request.contextPath}/movie/movieList?word=${word}" method="get">
					...
					<!-- 추가 -->
					<a href="${pageContext.request.contextPath}/movie/insertMovie" class="btn center-block bg-green n-white" role="button">
				...
				<table class="table table-hover bg-white">
					<tbody>
						<c:forEach var="list" items="${list}">
							<tr>
								<td><strong>${list.movieName}</strong></td>
								<td>
									<a href="${pageContext.request.contextPath}/movie/updateMovie?movieId=${list.movieId}" class="btn btn-none n-gray"role="button">
										<i class="fa fa-cog fa-2x" aria-hidden="true"></i>
									</a>
									<a href="${pageContext.request.contextPath}/movie/deleteMovie?movieId=${list.movieId}" class="btn rgba-red-strong"role="button">
